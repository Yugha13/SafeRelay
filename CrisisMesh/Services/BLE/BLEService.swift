...
final class BLEService: NSObject {
    ...
    func sendMessage(_ content: String, mentions: [String] = [], to recipientID: PeerID? = nil, messageID: String? = nil, timestamp: Date? = nil, priority: BitchatMessage.PriorityLevel = .info, messageType: BitchatMessage.MessageType = .normal) {
    ...
    func sendMessage(_ content: String, mentions: [String], messageID: String, timestamp: Date, priority: BitchatMessage.PriorityLevel, messageType: BitchatMessage.MessageType) {
    ...
    func sendPrivateMessage(_ content: String, to peerID: PeerID, recipientNickname: String, messageID: String, priority: BitchatMessage.PriorityLevel, messageType: BitchatMessage.MessageType) {
