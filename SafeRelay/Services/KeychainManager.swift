...
final class KeychainManager: KeychainManagerProtocol {
    ...
    private let service = SafeRelayApp.bundleID
    private let appGroup = "group.\(SafeRelayApp.bundleID)"
    ...
    private func saveDataWithResult(_ data: Data, forKey key: String, retryCount: Int = 2) -> KeychainSaveResult {
        ...
        var base: [String: Any] = [
            ...
            kSecAttrLabel as String: "SafeRelay-\(key)"
        ]
        #if os(macOS)
        ...
        if searchStatus == errSecSuccess, let items = result as? [[String: Any]] {
            for item in items {
                ...
                if accessGroup == appGroup {
                    ...
                    "com.SafeRelay.passwords",
                    "com.SafeRelay.deviceidentity",
                    "com.SafeRelay.noise.identity",
                    "chat.SafeRelay.passwords",
                    "SafeRelay.keychain",
                    "SafeRelay",
                    "com.SafeRelay"
                ].contains(service) {
