...
final class MessageFormattingEngine {
    ...
    private static func formatSystemMessage(_ message: SafeRelayMessage, isDark: Bool) -> AttributedString {
        var result = AttributedString()
    ...
    private static func formatMatch(_ text: String, type: MatchType, baseColor: Color, isSelf: Bool) -> AttributedString {
        ...
        case .mention:
            ...
            mentionStyle.font = .SafeRelaySystem(size: 14, weight: .semibold, design: .monospaced)
        ...
        case .url:
            ...
            style.font = .SafeRelaySystem(size: 14, design: .monospaced)
    ...
    private static func formatTimestamp(_ timestamp: String) -> AttributedString {
        ...
        style.font = .SafeRelaySystem(size: 10, design: .monospaced)
