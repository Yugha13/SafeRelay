...
final class NotificationService {
    ...
    func sendSOSNotification(from sender: String, distance: String? = nil) {
        let title = "🚨 SOS ALERT: \(sender)"
        let body = distance != nil ? "Emergency reported \(distance!) away. They need your help!" : "Emergency reported nearby. They need your help!"
        let identifier = "sos-\(UUID().uuidString)"
        
        sendLocalNotification(title: title, body: body, identifier: identifier, interruptionLevel: .critical)
    }
    ...
    func sendGeohashActivityNotification(geohash: String, titlePrefix: String = "#", bodyPreview: String) {
        ...
        let deeplink = "SafeRelay://geohash/\(geohash)"
    ...
    func sendNetworkAvailableNotification(peerCount: Int) {
        let title = "👥 SafeRelayters nearby!"
