...
struct SafeRelayApp: App {
    static let bundleID = Bundle.main.bundleIdentifier ?? "chat.SafeRelay"
    ...
    private func handleURL(_ url: URL) {
        if url.scheme == "SafeRelay" && url.host == "share" {
    ...
    private func checkForSharedContent() {
        ...
        guard let userDefaults = UserDefaults(suiteName: SafeRelayApp.groupID) else {
            return
        }
