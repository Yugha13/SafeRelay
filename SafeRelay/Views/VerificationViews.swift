        ...
        VStack(spacing: 0) {
            ...
            HStack {
                Text("verification.sheet.title")
                    .font(.SafeRelaySystem(size: 14, weight: .bold, design: .monospaced))
                ...
                Button(action: {
                    ...
                    Image(systemName: "xmark")
                        .font(.SafeRelaySystem(size: 14, weight: .semibold))
                        .foregroundColor(accentColor)
                }
                .buttonStyle(.plain)
            }
                ...
                if showingScanner {
                    ...
                    Button(action: { showingScanner = true }) {
                        Label("scan someone else's qr", systemImage: "camera.viewfinder")
                            .font(.SafeRelaySystem(size: 13, weight: .medium, design: .monospaced))
                    }
                    .buttonStyle(.bordered)
                    .tint(.gray)
                }
