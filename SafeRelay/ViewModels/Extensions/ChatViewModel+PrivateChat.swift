...
extension ChatViewModel {
    ...
    func sendVoiceNote(at url: URL) {
        ...
        Task.detached(priority: .userInitiated) { [weak self] in
            ...
            do {
                ...
                let packet = SafeRelayFilePacket(
    ...
    @MainActor
    func enqueueMediaMessage(content: String, targetPeer: PeerID?) -> SafeRelayMessage {
    ...
    func cleanupLocalFile(forMessage message: SafeRelayMessage) {
    ...
    @MainActor
    func handlePrivateMessage(_ message: SafeRelayMessage) {
    ...
    func addMessageToPrivateChatsIfNeeded(_ message: SafeRelayMessage, targetPeerID: PeerID) {
    ...
    @MainActor
    func mirrorToEphemeralIfNeeded(_ message: SafeRelayMessage, targetPeerID: PeerID, key: Data?) {
        guard let key,
    ...
    @MainActor
    func handleViewingThisChat(_ message: SafeRelayMessage, targetPeerID: PeerID, key: Data?, senderPubkey: String) {
    ...
    func processActionMessage(_ message: SafeRelayMessage) -> SafeRelayMessage {
    ...
    func migratePrivateChatsIfNeeded(for peerID: PeerID, senderNickname: String) {
        ...
        if privateChats[peerID] == nil || privateChats[peerID]?.isEmpty == true {
            var migratedMessages: [SafeRelayMessage] = []
    ...
    @MainActor
    func isMessageBlocked(_ message: SafeRelayMessage) -> Bool {
