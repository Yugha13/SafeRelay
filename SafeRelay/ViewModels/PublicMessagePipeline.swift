...
final class PublicMessagePipeline {
    ...
    private var buffer: [SafeRelayMessage] = []
    ...
    func enqueue(_ message: SafeRelayMessage) {
...
private extension PublicMessagePipeline {
    ...
    func flushBuffer() {
        ...
        var pending: [(message: SafeRelayMessage, contentKey: String)] = []
    ...
    func insertionIndex(for timestamp: Date, in messages: [SafeRelayMessage]) -> Int {
        var low = 0
