...
final class MockBLEService: NSObject {
    ...
    var sentMessages: [(message: SafeRelayMessage, packet: SafeRelayPacket)] = []
    var sentPackets: [SafeRelayPacket] = []
    var connectedPeers: Set<PeerID> = []
    var messageDeliveryHandler: ((SafeRelayMessage) -> Void)?
    var packetDeliveryHandler: ((SafeRelayPacket) -> Void)?
    ...
    func simulateIncomingMessage(_ message: SafeRelayMessage) {
    ...
    func simulateIncomingPacket(_ packet: SafeRelayPacket) {
        // Process through the actual handling logic
        if let message = SafeRelayMessage(packet.payload) {
