...
- **File:** `SafeRelayTests/Mocks/MockBLEService.swift`
...
- **Handlers:** Tests can observe data via `messageDeliveryHandler` (decoded `SafeRelayMessage`) and `packetDeliveryHandler` (raw `SafeRelayPacket`).
